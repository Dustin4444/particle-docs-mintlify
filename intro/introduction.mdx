...
3. **Social Logins**: Allow your users to create an in-app wallet with their email, Google/social accounts, etc. [Uses MPC-TSS](/social-logins/mpc-tss#security-mpc-tss). 

---

## Pick your path

<Tip>Still unsure which service better fits your project? Visit our [Start Here](/intro/which-product) page for a comparison and deeper breakdown.</Tip>
