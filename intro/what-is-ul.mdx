...
A **solver** is simply an **on-chain entity** with liquidity (e.g., an **LP** holding **USDT** or another [**Primary Token**](/universal-accounts/chains)). Particle currently operates the liquidity pools, with the goal of enabling **permissionless** participation in the future.
...
<CardGroup cols="1">
  <Card title="Integrate Chain Abstraction" icon="code" href="/universal-accounts/web-quickstart">
