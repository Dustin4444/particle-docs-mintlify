---
title: "What are Universal Accounts?"
...
Developers can integrate Universal Accounts easily into their dApps using the [Universal SDK](/universal-accounts/overview). UAs are compatible with both social logins and wallet connections and support gasless, cross-chain operations out of the box.
...
<Card title="Try the Universal SDK" icon="code" href="/universal-accounts/web-quickstart">
