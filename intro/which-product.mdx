...
<CardGroup cols={2}>
  ...
  <Card title="Accept deposits from any chain" icon="arrow-down-to-bracket" href="/universal-accounts/ua-reference/universal-deposit/overview">
...
| **Simple Deposit** | Per-chain deposit addresses; funds auto-bridge to your destination chain as USDC. Wallet-agnostic. Not compatible with Particle Connectkit/Authkit. → [Docs](/universal-accounts/ua-reference/universal-deposit/overview) |
