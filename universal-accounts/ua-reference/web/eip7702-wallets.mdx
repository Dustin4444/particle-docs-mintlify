...
<Warning>
  **EIP-7702 mode requires an embedded (WaaS) wallet.**
  ...
  JSON-RPC wallets do not support the `signAuthorization` call needed to create Type-4 transactions. If you need to support those wallets, use [Smart Account mode](/universal-accounts/ua-reference/web/initialization#smart-account-mode-json-rpc-wallets) instead.
</Warning>
