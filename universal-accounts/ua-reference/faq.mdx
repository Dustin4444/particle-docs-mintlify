...
<AccordionGroup>
  ...
  <Accordion title="Which platforms are supported by the SDK?" icon="desktop">
    ...
    <Tip>
      Check out our [SDK Reference](/universal-accounts/ua-reference/web/overview) for detailed platform-specific docs.
    </Tip>
  ...
  <Accordion title="What are Primary Assets, and how do they work?" icon="coins">
    ...
    <Info>
    Find a list of the supported Primary Assets in the [Supported Chains & Primary Assets](/universal-accounts/chains#primary-assets) page.
    </Info>

    Users can hold Primary assets on any [supported chain](/universal-accounts/chains). When a transaction (like a swap or transfer) is initiated, the SDK will:
  ...
  <Accordion title="Do users need to deposit assets into their Universal Account?" icon="vault">
    ...
    - Users must hold **at least one [Primary Asset](/universal-accounts/chains#primary-assets)** on their Universal Account.
