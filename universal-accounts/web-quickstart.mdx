...
- **A connected browser wallet** (MetaMask, etc.) — see [Integrate with Browser Wallets](/universal-accounts/how-to/provider).
- **Magic / Dynamic / Privy** — embedded wallets via JWT auth. See [Using Magic's API Wallet](/universal-accounts/how-to/ua-magic).
...
<CardGroup cols="2">
  ...
  <Card title="SDK reference" icon="rectangle-terminal" href="/universal-accounts/ua-reference/desktop/web">
