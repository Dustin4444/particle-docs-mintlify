...
To show the user's total balance of [Primary Assets](/universal-accounts/chains#primary-assets) across chains, the app uses `getPrimaryAssets()` from the Universal Accounts SDK.
...
<Info>
  [Primary Assets](/universal-accounts/chains#primary-assets) are key tokens for which Universal Accounts have deep liquidity. As such, the SDK uses them as the base assets for any cross-chain operation—including gas, swaps, and liquidity routing.
</Info>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-gray-600 text-sm mt-1">
                    ...
                    <a
                      ...
                      href="https://developers.particle.network/universal-accounts/chains#primary-assets"
                    >
                      primary assets
                    </a>{" "}
                    from every chain
