...
<Steps>
  ...
  <Step title="Deposit Tokens into the Universal Account">
    The app then scans their EOA wallet for **USDC** and **USDT** across all [supported chains](/universal-accounts/chains).
    ...
    <Note>
      The demo includes a basic UI for depositing, but users can also manually deposit any supported [Primary Asset](/universal-accounts/chains#primary-assets) directly to the Universal Account address.
    </Note>
  </Step>
