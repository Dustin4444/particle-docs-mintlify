...
<Card title="Get started with Universal Accounts" icon="rocket" href="/universal-accounts/web-quickstart">
...
<Note>
  This unified balance only includes Primary Assets, **_across_** [_any_](/universal-accounts/chains) _chain_ **_the UA holds them on_**. The SDK will then automatically select the most efficient payment source and route assets to execute the transaction.
</Note>
...
<CardGroup cols="2">
  <Card title="SDK Reference" icon="code" href="/universal-accounts/ua-reference/web/balances">
