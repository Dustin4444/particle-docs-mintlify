...
<Note>
Each asset includes metadata and a breakdown of holdings per chain. For a full list of supported Primary Assets, check the [Supported Chains and Primary Assets](/universal-accounts/chains#primary-assets) page.

You can find more details in the full [Universal Accounts SDK Reference](/universal-accounts/ua-reference/web/overview).
</Note>
