...
<Note>
The Universal Account SDK allows for various types of transactions, find more details in the [Universal Accounts SDK reference](/universal-accounts/ua-reference/web/overview).
</Note>
...
To level up your Chain Abstraction skills, explore the [**How-to** section](/universal-accounts/how-to/provider) for more advanced use cases, including:

- How to [preview transactions details](/universal-accounts/how-to/tx-preview)
- How to [use Universal Accounts as a deposit flow](/universal-accounts/how-to/deposit-flow) in existing apps
